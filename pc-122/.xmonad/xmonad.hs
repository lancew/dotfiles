...
myKeys conf@(XConfig {XMonad.modMask = modm}) = M.fromList $
    ...
    -- turn off email alert flashing led
    , ((0, 0xff14   ), spawn "touch /tmp/no-blink")
...
myLayout =
  ...
  tiled||| Mirror tiled ||| ThreeCol 1 (3/100) (1/2) ||| ThreeColMid 1 (3/100) (1/2)
  where
...
--    spawn "feh --bg-scale --no-xinerama Spy_vs_Spy.jpg"
    spawn "sudo rmmod pcspkr"
    spawn "setxkbmap gb"
    spawn "xkbset -a"
    spawn "xsetroot -cursor_name left_ptr"
    spawn "xterm -e 'ssh-agent' &"
    spawn "xterm -e 'ssh-add' &"
    spawn "xrandr --output DisplayPort-0 --rotate left --auto"
